		...
		<CardContent class="space-y-4">
			...
			<div>
				...
				<div class="flex items-center gap-2">
					...
					<Button variant="outline" size="icon" onclick={() => accessKeyClipboard.copy(data.accessKey)}>
			...
			<div>
				...
				<div class="flex items-center gap-2">
					<Input type="password" readonly value="••••••••••••••••••••••••••••••••" class="flex-1" />
					<Button variant="outline" size="icon" onclick={() => accessSecretClipboard.copy(data.accessSecret)}>
